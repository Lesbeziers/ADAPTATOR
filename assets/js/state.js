...
const State = {
  ...
  systemLayers: {
    ...
    'FANART DEST.':      [ { key: 'mockup', label: 'MOCKUP', src: 'assets/img/checkers/FANART_DESTACADO_PUBLI_Check.png' } ],
    ...
    'FANART MÓVIL':      [ { key: 'mockup', label: 'MOCKUP', src: 'assets/img/checkers/FANART_MOVIL_Check.png' } ],
